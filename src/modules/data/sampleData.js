...
const tasks = [
  new Task({
    ...
    description:
      "Scavenge for un-irradiated water or repair the filtration unit.",
    dueDate: "2023-11-25",
    priority: "critical",
  }),
  new Task({
  ...
  new Task({
    ...
    description:
      "Review pre-war schematics to increase Science and Repair skills.",
    dueDate: "2023-11-24",
    priority: "low",
  }),
  new Task({
    ...
    description:
      "Compile the weekly settlement survival statistics for the vault record.",
    dueDate: "2023-11-23",
    priority: "critical",
  }),
  new Task({
