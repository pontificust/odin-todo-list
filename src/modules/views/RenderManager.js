...
export class RenderManger {
  ...
  #getProcessedTasks() {
    const { currentProjectId, currentTasksArr, activeFilter, activeSort } =
      this.stateManager.uiState;
  ...
  #createTaskElement(taskData) {
    const { task, taskName, taskPriority, taskDate, taskXp, tasksWrapper } =
      this.#parseTaskStructure();
  ...
  #updateTasksArr(tabName) {
    const newTaskArr =
      tabName === "openActive" ? "activeTasks" : "completedTasks";
